          ...
          <tbody>
            {users.length === 0 ? (
              ...
              users.map((user, index) => (
                <tr
                  key={index}
                  className="border-b border-gray-200 bg-white rounded-md shadow-sm mb-2"
                >
                  ...
                  <td className="px-4 py-2">
                    {user.isBlocked ? (
                      <p className="bg-red-300 rounded-md pl-2 pr-2">Blocked</p>
                    ) : (
                      <p className="bg-green-300 rounded-md pl-2 pr-2">
                        Active
                      </p>
                    )}
                  </td>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
          <div className="bg-white p-8 rounded-lg shadow-lg w-1/3 max-w-md">
            ...
            <div className="flex justify-center">
              <button
                className="px-6 py-3 bg-red-500 text-white rounded mr-4"
