...
const UserDetails = () => {
  ...
  const [edit, setEdit] = useState<boolean>(false);
    ...
    const editSubmit = async (values: {
        userId: any; firstName: string; lastName: string; phone: string 
    }) => {
        try {
      ...
      const validationSchema = Yup.object({
        firstName: Yup.string()
          .matches(nameRegex, 'First Name must start with a capital letter and contain only letters')
          .required('First Name is required'),
        lastName: Yup.string()
          .matches(nameRegex, 'Last Name must start with a capital letter and contain only letters')
    ...
    return (
        <>
            ...
            <h2 className="ml-8 mr-5 mt-5">
              Hello, this is your profile page here you can view your profile,
              edit and do all other stuff, you can see the courses you enrolled,
              tutors you follow and your progress. Below is the referral code
              for inviting your friend. Click to see how referral works.
              <span
          ...
          <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex items-center justify-center">
            <div className="bg-white p-6 rounded-lg shadow-lg  w-1/2">
              ...
              <p className="mt-4 mb-4">
                Sure, here's a small description for how the referral works:
                "When you invite a friend, and they either make a purchase or
                take a subscription, they will receive $100, and you, as the
                person who invited them, will receive $200."
              </p>
              <button
